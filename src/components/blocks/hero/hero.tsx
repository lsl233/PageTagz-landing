...
export default function HeroSection() {
  ...
  const linkPrimary =
    'https://chromewebstore.google.com/detail/pagetagz/jodahbeeakklmdmjajjgfgocibpmkipe';
  const linkSecondary = 'https://page-tagz-web.vercel.app/';
            ...
            <div className="mx-auto max-w-7xl px-6">
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  >
                    <LocaleLink href={linkSecondary} target="_blank">
